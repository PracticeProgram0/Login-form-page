    ...
    public partial class salary : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if(RadioButton1.Checked)
            {
                ...
                Label1.Text = TextBox1.Text + "Total salary is" + to + "with bonus";
            }
            else if(RadioButton2.Checked)
            {
                int to = Convert.ToInt32(TextBox2.Text) + 3000;
                Label1.Text = TextBox1.Text + "Total salary is" + to + "with TA";

            }
            else
            {
                int to = Convert.ToInt32(TextBox2.Text) + 4000;
                Label1.Text = TextBox1.Text + "Total salary is" + to + "with DA ";
